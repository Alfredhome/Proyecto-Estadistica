 ...
 * @author Admin
 */
public class ReglaMultiplicacion extends javax.swing.JFrame {
    FondoPanel12 fondo = new FondoPanel12();
    int n1,n2,n3,n4,n5,n6 ;
    
    int resp1,resp2;
    public ReglaMultiplicacion() 
    {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReglaMultiplicacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReglaMultiplicacion().setVisible(true);
            }
        });
    }
